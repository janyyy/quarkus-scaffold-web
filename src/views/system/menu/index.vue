<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column v-if="checkPer(['admin','menus:edit','menus:del'])" label="操作" width="130px" align="center" fixed="right">
        <template slot-scope="scope">
          <udOperation
            :data="scope.row"
...
export default {
  ...
  cruds() {
    return CRUD({ title: '菜单', url: 'api/menus', sort: ['menuSort,asc'], crudMethod: { ...crudMenu }})
  },
