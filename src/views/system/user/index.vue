    ...
    <el-row :gutter="20">
      ...
      <el-col :xs="15" :sm="18" :md="19" :lg="20" :xl="20">
        ...
        <div class="head-container">
          ...
          <crudOperation show="" :permission="permission">
            <el-button
              ...
              @click="resetPass(crud.selections)"
            >密码重置</el-button>
          </crudOperation>
        </div>
        <!--表单渲染-->
        ...
        <el-table ref="table" v-loading="crud.loading" :data="crud.data" style="width: 100%;" @selection-change="crud.selectionChangeHandler">
          ...
          <el-table-column :show-overflow-tooltip="true" width="300" prop="email" label="邮箱" />
...
export default {
  ...
  methods: {
    resetPass(data) {
      crudUser.resetPass(data[0].id).then(res => {
        this.$message({
          message: '操作成功,选中用户密码已重置为：123456',
          type: 'success'
        })
      })
    },
